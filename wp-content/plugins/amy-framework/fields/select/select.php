 ...
 * @version 1.0.0
 */
class AmyFramework_Option_select extends AmyFramework_Options {
	...
	public function output() {
		...
		if ( isset( $this->field['options'] ) ) {
			...
			if ( isset( $this->field['attributes']['multiple'] ) ) {
				echo '<input type="hidden" name="' . $this->element_name() . '" value="" />';
			}
