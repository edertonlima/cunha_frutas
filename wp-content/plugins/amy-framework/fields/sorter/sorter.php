 ...
 * @version 1.0.0
 */
class AmyFramework_Option_Sorter extends AmyFramework_Options {
	...
	public function output() {
		...
		$enabled_title	= (isset( $this->field['enabled_title'] )) ? $this->field['enabled_title'] : __( 'Enabled Modules', 'amy-framework' );
		$disabled_title	= (isset( $this->field['disabled_title'] )) ? $this->field['disabled_title'] : __( 'Disabled Modules', 'amy-framework' );

		echo '<div class="amy-modules">';
		echo '<h3>' . $enabled_title . '</h3>';
		echo '<ul class="amy-enabled">';
